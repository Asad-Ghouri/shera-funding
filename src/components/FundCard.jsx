...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }) => {
  ...
  return (
    <div className="sm:w-[275px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer card-c" onClick={handleClick}>
      <img src={image} alt="fund" className="w-full h-[258px] object-cover rounded-[15px] fund-img" />
